...
class Pusher {
  static const MethodChannel _channel =
      const MethodChannel('com.github.rinckd/pusher');
  final EventChannel _eventChannel =
      const EventChannel('com.github.rinckd/pusherStream');
  ...
  void _handleEvent([dynamic arguments]) async {
    ...
    if (message.isEvent) {
      ...
      _socketId = await _channel
          .invokeMethod('getSocketId', {'instanceId': _instanceId});
